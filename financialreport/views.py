...
#         dict = {'total_expense':total_expense, 'total_income':total_income, 'expense_list':expense_list}
#         df = pd.DataFrame(dict)
#         df.to_csv


#         data = JsonResponse({'total_expense':total_expense, 'total_income':total_income, 'expense_list':expense_list}, safe = False)
#         fileName = 'FinancialReport'
#         path = 'C:/Programming/Semester 5/PPL/iSaveIt/financialreport/static'
